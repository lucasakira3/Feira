...
// import feiralogo from "../assets/feiralogo.png"; // Mantido comentado caso precise
import MapaSection from "../components/MapaSection.jsx";
...
function Produtos() {
  ...
  // Função passada para MapaSection (seleciona apenas 1 região por vez)
  const handleRegiaoChange = (value) => {
    setSelectedRegiao((prev) => (prev.includes(value) ? [] : [value]));
  ...
  // Lógica de filtragem para região
      ...
      <main className="container main-content main-produtos">
        <div className="container-fluid">
          <div className="row">
              ...
              <div className="categorias filter-scroll">
                ...
                <div className="frutas filtro">
                  ...
                  {[
                    ...
                    <span key={item.value} style={{ cursor: "pointer" }}>
                      <input
                        id={item.value}
                        type="checkbox"
                        value={item.value}
            ...
            {/* Produtos */}
            <div
              className="col-xl-10 col-lg-8 col-md-8 col-sm-12"
              ref={productsRef}
            >
                  ...
                  <div className="col-md-3" key={i}>
                    ...
                    >
                      ...
                      <div className="card-body d-flex flex-column">
                        ...
                        {/* PREÇO + BOTÃO LADO A LADO (fixo dentro da caixa) */}
                        <div className="mt-auto d-flex justify-content-between align-items-center gap-2">
                          <div className="valor_venda fw-bold m-0">{p.price}</div>
        ...
        {/* Passa a função handleRegiaoChange e o productsRef para o MapaSection */}
        <MapaSection
          onSelectRegiao={handleRegiaoChange}
